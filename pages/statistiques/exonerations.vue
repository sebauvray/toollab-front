<template>
  <div>
    <PageContainer>
      ...
      <h1 class="text-xl font-bold text-gray-900 mb-5">Exonérations</h1>
      ...
      >
        <template #default="{ item, isLastRow }">
          ...
          >
            ...
            <div class="col-span-2">
              <div v-if="item.exoneration_type === 'complete'" class="flex items-center gap-1.5">
                <span class="inline-flex px-1.5 py-1 text-xs font-medium rounded-full bg-orange-100 text-orange-800">
                  Complète
                </span>
                <span class="text-xs text-gray-500">(100%)</span>
              </div>
              <div v-else class="flex items-center gap-1.5">
                <span class="inline-flex px-1.5 py-1 text-xs font-medium rounded-full bg-yellow-100 text-yellow-800">
                  Partielle
                </span>
            ...
            <div class="col-span-3 text-xs text-gray-600 pr-3">
