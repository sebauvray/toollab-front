    ...
    <div class="grid gap-y-4">
      <div class="grid grid-cols-3 gap-x-8 mt-1 w-full">
        <div class="flex relative flex-col col-span-1 gap-y-4 px-6 py-3 bg-white rounded-2xl border">
          <div class="flex items-center px-12 py-1.5 mx-auto text-lg font-bold text-center rounded-lg bg-gray-light font-montserrat hover:cursor-pointer"
          ...
          <div class="flex flex-col gap-y-0.5 justify-center">
            ...
            <template v-if="!isEditing">
              <div class="inline-flex gap-x-1.5 items-center text-xs font-medium font-montserrat text-default">
                <HomeTLB />
            ...
            <template v-else>
              <div class="inline-flex gap-x-1.5 items-center mb-1.5 text-xs font-medium font-montserrat text-default">
                <HomeTLB />
                <input
          ...
          <template v-if="family.students && family.students.length > 0">
            <div v-for="(student, index) in family.students" :key="student.id" class="grid grid-cols-12 py-1.5 text-sm font-nunito border-b border-[#E6EFF5] last:border-b-0">
              ...
              <div class="col-span-3 flex">
                <div class="inline-flex justify-start font-bold text-gray-700 items-center rounded-lg text-sm"
      ...
      <div class="grid grid-cols-2 gap-x-8 w-full h-80 mt-1">
        <div class="flex flex-col col-span-1 gap-y-4 py-3 bg-white rounded-2xl border">
          ...
          <div v-else-if="paiementError" class="inline-flex flex-col gap-y-3 justify-center items-center w-full">
            <PaiementEmpty width="200" height="160" />
            <div class="text-sm font-medium font-montserrat text-red-500">Erreur de chargement</div>
          </div>

          <div v-else-if="detailsPaiement && (detailsPaiement.montant_total > 0 || detailsPaiement.montant_paye > 0)" class="px-6 space-y-3">
            <div class="space-y-2">
              ...
              <div class="flex justify-between text-sm">
                ...
                <span class="font-medium text-green-600">{{ Math.round(detailsPaiement.montant_paye) }}€</span>
              </div>
            ...
            <div v-if="detailsPaiement.details" class="space-y-1">
              ...
              <div v-if="detailsPaiement.details.cheque > 0" class="flex justify-between text-sm">
                <span class="text-gray-500">🧾 Chèques ({{ detailsPaiement.details.cheques?.length || 0 }})</span>
